...
/**
 * Simplified method for performing [action] on item at the specified
 * [position] in the RecycleView
 */
...
/**
 *Check that the list item at the specified [position] in the RecycleView
...
private class AtPosition(
    ...
    override fun describeTo(description: Description?) {
        description?.appendText("recycleView with the specified ID and at position: $position")
    }
